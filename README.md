...
### 3. Current Control & Sensing Stage (CC Mode)
  ...
  #### Precision Reference (U1, U3, RV1):
   ##### U1 (L78L05): Standard linear regulator generating a clean 5V rail.
   ##### U3 (TL431): Precision adjustable reference IC producing a ultra-stable voltage.
   ##### RV1 (10k Potentiometer): Sets the current limit reference threshold for the operational amplifier.
   ##### Op-Amp Control (U4 - LM358): U4A : 
